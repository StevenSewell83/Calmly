...
export const aiSettingsBridge: AiBridge = {
  getSettings() {
    return ipcRenderer.invoke("ai:getSettings") as ReturnType<AiBridge["getSettings"]>;
  },
  setSettings(patch) {
    return ipcRenderer.invoke("ai:setSettings", patch) as ReturnType<AiBridge["setSettings"]>;
  },
  hasKey() {
    return ipcRenderer.invoke("ai:hasKey") as ReturnType<AiBridge["hasKey"]>;
  },
  setKey(value) {
    return ipcRenderer.invoke("ai:setKey", value) as ReturnType<AiBridge["setKey"]>;
  },
  clearKey() {
    return ipcRenderer.invoke("ai:clearKey") as ReturnType<AiBridge["clearKey"]>;
  },
  testConnection() {
