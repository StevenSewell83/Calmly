...
//
// Used by the core-loop suite so each spec doesn't have to re-wire
// the same scaffolding. Foundations specs still build their own
// scaffolding because they exercise auth itself; here auth is given.
...
// Re-export so specs can `import { seedUser, requireDocker } from
// '../fixtures/seedUser'` and not have to reach into ./docker themselves.
